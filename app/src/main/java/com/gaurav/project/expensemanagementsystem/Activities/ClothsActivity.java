    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datechage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ClothsActivity.this,
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try{
                    ...
                    if (edtincome.length()==12) {
                        Toast.makeText(ClothsActivity.this, "Cannot be too large", Toast.LENGTH_SHORT).show();
                    }
                }catch(Exception e){
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ClothsActivity.this, "Enter Valid Amount", Toast.LENGTH_SHORT).show();
                    edtincome.requestFocus();
                }
                ...
                {
                    Toast.makeText(ClothsActivity.this, "Amount should be greater than 0", Toast.LENGTH_SHORT).show();
                    edtincome.requestFocus();
                }
                else
                {
                    boolean isInserted = mydb.inertData("CLOTH",edtincome.getText().toString(),txtdate.getText().toString());

                    if (isInserted)
                    {
                        Toast.makeText(ClothsActivity.this, "Data inserted", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(ClothsActivity.this, "Data not inserted", Toast.LENGTH_SHORT).show();
                    }
                    Intent i = new Intent(ClothsActivity.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
