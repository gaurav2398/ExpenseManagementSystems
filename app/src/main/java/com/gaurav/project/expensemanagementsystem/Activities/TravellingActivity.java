    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datechage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TravellingActivity.this,
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try{
                    ...
                    if (edtincome.length()==12) {
                        Toast.makeText(TravellingActivity.this, "Cannot be too large", Toast.LENGTH_SHORT).show();
                    }
                }catch(Exception e){
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    boolean isInserted = mydb.inertData("TRAVELLING",edtincome.getText().toString(),txtdate.getText().toString());

                    if (isInserted)
                    {
                        Toast.makeText(TravellingActivity.this, "Data inserted", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
